...
public class FenAppServeur_Card extends javax.swing.JFrame implements ConsoleServeur {
    ...
    public FenAppServeur_Card() throws IOException {
        initComponents();
    ...
    private void BStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BStartActionPerformed
        ...
        try {
            ...
            int maxthread = Integer.parseInt(Utils.getItemConfig(path, "maxthreadCard"));
            ThreadServeur ts = new ThreadServeur(port,  new ListeTaches(), this, maxthread);
            ts.start();
        } catch (IOException ex) {
            Logger.getLogger(FenAppServeur_Card.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenAppServeur_Card.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FenAppServeur_Card().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(FenAppServeur_Card.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
