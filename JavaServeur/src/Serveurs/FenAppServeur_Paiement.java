...
public class FenAppServeur_Paiement extends javax.swing.JFrame implements ConsoleServeur {
    ...
    public FenAppServeur_Paiement() throws IOException {
        initComponents();
        
        port = Integer.parseInt(Utils.getItemConfig(path, "PORT_PAY"));
    ...
    private void BStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BStartActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FenAppServeur_Paiement.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenAppServeur_Paiement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FenAppServeur_Paiement().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(FenAppServeur_Paiement.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
